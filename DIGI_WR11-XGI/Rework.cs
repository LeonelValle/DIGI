    ...
    public partial class Rework : Form
    {
        ...
        private void btn_aceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int regreso = int.Parse(operador.ReturnValue("select id_user from tb_User where idemp = '" + txt_empleado.Text+"' and isAdmin = 1"));
                ...
                if (regreso > 0)
                {
                    ...
                    if ((enet = IsFormAlreadyOpen(typeof(Retrabajo))) == null)
                    {
                        ee.ShowDialog(this);
                        this.Close();
                    }
