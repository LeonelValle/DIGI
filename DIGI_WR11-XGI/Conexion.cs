...
namespace DIGI_WR11_XGI
{
    class Conexion
    {
        ...
        //Con1 = new SqlConnection(@"Data Source=192.168.4.5\MSSQLDB;Initial Catalog=digidb;User ID=sa;Password=Password01;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        Con1 = new SqlConnection(@"Data Source=MEX-SQL-001;Initial Catalog=digidb;User ID=admin_sql;Password=DaBatase#40107;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
