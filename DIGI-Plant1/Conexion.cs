...
namespace DIGI_Plant1
{
    class Conexion
    {
        ...
        public Conexion() =>
                Con1 = new SqlConnection(@"Data Source=MEX-SQL-001;Initial Catalog=DIGIP1db;User ID=admin_sql;Password=DaBatase#40107;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
       //Con1 = new SqlConnection(@"Data Source=192.168.1.4\SQLEXPRESS;Initial Catalog=DIGIP1db;User ID=admin;Password=mbettaglo;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        //RESPARLDO
