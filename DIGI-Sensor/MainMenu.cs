...
namespace DIGI_Sensor
{
    public partial class MainMenu : Form
    {
        ...
        private void btn_VerifiedBox_Click(object sender, EventArgs e)
        {
            CheckingBox no = new CheckingBox();

            Form NuevaOrden;
            if ((NuevaOrden = IsFormAlreadyOpen(typeof(CheckingBox))) == null)
            {
                no.ShowDialog(this);
            }
        ...
        {
            AuntBattery no = new AuntBattery();

            Form NuevaOrden;
            if ((NuevaOrden = IsFormAlreadyOpen(typeof(AuntBattery))) == null)
            {
                no.ShowDialog(this);
            }
