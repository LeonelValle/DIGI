...
namespace DIGI_Sensor3test
{
    class Conexion
    {
        ...
        //Con1 = new SqlConnection(@"Data Source=192.168.4.5\SQLEXPRESS;Initial Catalog=DIGITraceTest;User ID=sa;Password=Mexmei15!;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        //RESPARLDO
        //Con1 = new SqlConnection(@"Data Source=192.168.4.5\SQLEXPRESS;Initial Catalog=DIGITrace;User ID=sa;Password=Mexmei15!;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
